...
//------------------------------------------------- 
 ...
 $param = "INSERT INTO Users (login,name,surname,fathername,phone,photo,typeactivit,title,pass,datetime,email) VALUES ('$this->login','$this->name','$this->surname','$this->fathername','$this->phone','$this->photo','$this->typeactivit','$this->title','$this->pass','$this->datetime','$this->email')";
...
//------------------------------------------------- 
  public function loged(){
    if(isset( $_SESSION['user'])){
        echo '<meta  http-equiv="refresh" content="0;http://sitestart3/tools" >';
      //header('Location: http://sitestart/loged');
    }
    else{
         echo '<meta  http-equiv="refresh" content="0;http://sitestart3/registration" >';
